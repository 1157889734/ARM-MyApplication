...
QT_MOC_LITERAL(1, 10, 22), // "KeyboardPressKeySignal"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 13) // "buttonNumslot"

    },
    "CKeyboard\0KeyboardPressKeySignal\0\0"
    "buttonNumslot"
};
...
void CKeyboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->KeyboardPressKeySignal((*reinterpret_cast< char(*)>(_a[1]))); break;
        ...
        {
            using _t = void (CKeyboard::*)(char );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CKeyboard::KeyboardPressKeySignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CKeyboard::KeyboardPressKeySignal(char _t1)
{
